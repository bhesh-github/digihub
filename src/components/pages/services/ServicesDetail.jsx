						...
						<p className="inner">
							...
							<span
								...
								dangerouslySetInnerHTML={{
									__html: contentState.description && contentState.description,
								}}
							/>
							<br/>
							 <img src={middelVector}style={{width: "100%"}} />
							{/* <span
								className="description"
								// dangerouslySetInnerHTML={sanitizedData()}
								dangerouslySetInnerHTML={{
...
ServicesDetail.defaultProps = {
	service: [
		...
		},
		{
			...
			name: 'Insta Loan',
			description: [
				'InstaLoan is an innovative automated micro-lending solution designed to provide instant credit to customers during various events such as shopping, emergencies, or missed payday. It leverages advanced artificial intelligence (AI) and integrates with comprehensive data sources to assess the creditworthiness of individuals in real-time, enabling banks to disburse loans quickly and efficiently.<br/>',
